...
{
    public class ShopItDBContext : IShopItDBContext
    {
        private ProductsResponseModel[] products = new ProductsResponseModel[]
        {
        ...
        private CountryRatesResponseModel[] countryRates = new CountryRatesResponseModel[] 
        { 
        ...
        private ShippingChargesResponseModel[] shippingCharges = new ShippingChargesResponseModel[]
        {
        ...
        public CountryRatesResponseModel[] GetCountryRates()
        {
            return countryRates;           
        }

        public ShippingChargesResponseModel[] GetShippingCharges()
        {
            return shippingCharges;            
        }

        public int CreateOrder(CreateOrderRequestModel order)
        {      
